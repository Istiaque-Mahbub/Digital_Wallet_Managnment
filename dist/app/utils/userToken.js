...
exports.newAccessTokenWithRefreshToken = exports.createUserTokens = void 0;
...
const newAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "User Doesn't Exists");
    }
    if (isUserExist.isActive === user_interface_1.IS_ACTIVE.BLOCKED) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "User is blocked");
    }
    if (isUserExist.isActive === user_interface_1.IS_ACTIVE.INACTIVE) {
...
exports.newAccessTokenWithRefreshToken = newAccessTokenWithRefreshToken;
