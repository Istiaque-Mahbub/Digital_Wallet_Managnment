...
const initPayment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_services_1.PaymentService.initPayment(userId);
...
const successPayment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (payment_services_1.PaymentService === null || payment_services_1.PaymentService === void 0 ? void 0 : payment_services_1.PaymentService.successPayment(query));
    if ((result === null || result === void 0 ? void 0 : result.message) === 'Payment Successfully') {
