...
const getNewAccessToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const newAccessToken = yield (0, userToken_1.newAccessTokenWithRefreshToken)(refreshToken);
    console.log(newAccessToken);
    return {
        accessToken: newAccessToken
    };
});
const resetPassword = (oldPassword, newPassword, decodeToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isOldPasswordMatch) {
        throw new AppError_1.default(http_status_codes_1.default.UNAUTHORIZED, "Old password doesn't matched");
    }
